        ...
        return this.each(function () {
            ...
            if (oAddNewRowForm.length != 0) {
                ...
                if (oAddNewRowButton.length != 0) {
                    ...
                    if ($(properties.sAddDeleteToolbarSelector).length == 0)
                        throw "No se encuentra el botón para agregar nueva forma fila para agregar nuevo registro";
                    else
            ...
            if (oAddDeleteToolbar.length != 0) {
                if (oAddNewRowButton == null && properties.sAddNewRowButtonId != ""
                    && oAddNewRowForm != null) {
                    oAddDeleteToolbar.append("<button id='" + properties.sAddNewRowButtonId + "' class='add_row'>Agregar Fila</button>");
                    oAddNewRowButton = $("#" + properties.sAddNewRowButtonId);
                    oAddNewRowButton.click(function () { oAddNewRowForm.dialog('open'); });
                }
                if (oDeleteRowButton == null && properties.sDeleteRowButtonId != "") {
                    oAddDeleteToolbar.append("<button id='" + properties.sDeleteRowButtonId + "' class='delete_row'>Borrarla</button>");
                    oDeleteRowButton = $("#" + properties.sDeleteRowButtonId);
                    oDeleteRowButton.click(fnOnRowDelete);
                }
            }
