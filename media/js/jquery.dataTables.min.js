...
this._iDisplayStart + this.aiDisplay.length : Math.min(this._iDisplayStart + this._iDisplayLength, this._iRecordsDisplay) : this._iDisplayEnd
                ...
                sLengthMenu: "Mostrar _MENU_ registros por página", sZeroRecords: "No Existen Datos - Disculpe", sEmptyTable: "No data available in table", sInfo: "Muestra _START_ to _END_ of _TOTAL_ registros", sInfoEmpty: "Muestra 0 al 0 de 0 registros", sInfoFiltered: "(filtered from _MAX_ total registros)", sInfoPostFix: "", sSearch: "Buscar:", sUrl: "", oPaginate: { sFirst: "Primera", sPrevious: "Anterior", sNext: "Proxima", sLast: "Ultima" }, fnInfoCallback: null
